...
import { descriptionUpdateSchema, loginSchema, signupSchema } from "../schemas/users.schema.js";
...
usersRouter.put("/posts/:id", authorization, validateSchema(descriptionUpdateSchema), updatePost);
